 ...
 * Columns in array mode valid params are 'attribute', 'headers', 'format', 'value', and footer (TODO).
 ...
 * [1] => Array([name] => Example, [email] => example@yiiersoft.com, [framework interest] => Yii2));
 *
...
class Excel extends \yii\base\Widget
{
    ...
    {
        $keys = [];
        foreach (range(1, $this->setStartColNum) as $item) {
            $keys = ArrayHelper::remove($sheetData, $item);
        }
    ...
    public function readFile($fileName)
    {
        ...
        if ($sheetCount > 1) {
            ...
            if ($sheetDatas && isset($this->getOnlySheet) && $this->getOnlySheet != null) {
     ...
     * ~~~
     *
     * $data = \yiier\phpexcel\Excel::import($fileName, ['setFirstRecordAsKeys' => true]);
     *
     * ~~~
     *
